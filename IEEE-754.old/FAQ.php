...
<html <?php echo $html_attributes;?>>
  ...
  <body>
    ...
    <dd>
      The code was written in 2011 by Michale Lubow, an undergraduate Computer Science major at Queens
      College, under the supervision of Dr. Christopher Vickery. The previous calculators were first
      written by another Queens College major, Quanfei Wen, also under Dr. Vickery’s supervision, in
    ...
    <dl>
      ...
      <dd>
        ...
        <p>
          ...
          use your favorite
          search engine instead. “Kevin’s Chart” 
          <a href="http://babbage.cs.qc.cuny.edu/IEEE-754.old/References.xhtml#tables"> is still 
          there</a>, but has not been updated
          to handle the 2008 version of the IEEE-754 standard.
        </p>
      </dd>
      <dt>
        What’s changed?
      ...
      <dd>
        ...
        <p>
          ...
          Arithmetic library to do the underlying calculations. The old calculators used JavaScript
          for its calculations, with several painstakingly-developed constants to handle edge cases.
        </p>
        <p>
        ...
        <p>
          ...
          Binary128 (quad precision) data type intoduced with in IEEE-754-2008.
        </p>
        <p>
          The new code also supports more flexibility in entering values for analysis. In particular,
          being able to enter rational numbers means you can explore the representation of repeating
          fractions.
        </p>
      </dd>
      <dt>
